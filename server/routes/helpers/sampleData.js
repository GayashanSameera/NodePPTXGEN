...
import { BASE_TABLE_OPTS, BASE_TEXT_OPTS_L, BASE_TEXT_OPTS_R, FOOTER_TEXT_OPTS, IMAGE_PATHS, TESTMODE } from "./enums";
import {
    ACCENT_COLORS,
    CHART_DATA,
    COLORS_CHART,
...
export function genSlide01(pptx) {
    ...
    slide.addTable([[{ text: " Multiple Chart Example", options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]], BASE_TABLE_OPTS);
...
export function genSlide06(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
export function genSlide07(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
// SLIDE 8: Line Chart
export function genSlide08(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
export function genSlide09(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
    slide.addTable(
...
export function genSlide10(pptx) {
    const intWgap = 4.25;
...
// SLIDE 11: Area Chart
export function genSlide11(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
// SLIDE 12: Pie Chart
export function genSlide12(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
export function genSlide13(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
export function genSlide14(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
export function genSlide15(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
export function genSlide16(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
export function genSlide17(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
export function genSlide18(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
export function genSlide19(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
export function genSlide20(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
export function genSlide21(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
export function devSlide01(pptx) {
...
export function devSlide02(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts-DevTest" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
export function devSlide03(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts-DevTest" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
export function devSlide04(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts-DevTest" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
...
export function devSlide05(pptx) {
    let slide = pptx.addSlide({ sectionTitle: "Charts-DevTest" });
    slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html");
